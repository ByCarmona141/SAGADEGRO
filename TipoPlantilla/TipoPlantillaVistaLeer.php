...
?>
<table id="Table_TipoPlantilla" class="table table-striped table-bordered  table-hover datatable"
	...
	<tr>
		...
		<th width="90%" class="sortable" ><div class="text-center"> Nombre </div></th>
	</tr>
	</thead>
	<tbody>
	</tbody>
