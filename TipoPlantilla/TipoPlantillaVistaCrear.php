...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_TipoPlantilla" id="Form_TipoPlantilla" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>" >
	<fieldset>
	...
	?>
		<input type="hidden" name="TipoPlantillaInsert" value="TipoPlantillaInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
