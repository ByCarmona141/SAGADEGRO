...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_CelaTipoDeElemento" id="Form_CelaTipoDeElemento" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>">
	<fieldset>
	...
	?>
		<input type="hidden" name="CelaTipoDeElementoInsert" value="CelaTipoDeElementoInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
