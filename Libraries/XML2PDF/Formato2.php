...
<table width="'.$tamanio_dehoja.'" border="1" frame="void">
 ...
 //if(!is_null($url_logo))
 	$mihtml .='<img style="height:100px;border:none;" src="http://efectosfiscales.mx/'.$url_logo.'" />';
 ...
 $mihtml .=' 	
  ...
  <table width="'.$tamanio_dehoja.'" border="1" frame="void">
  <tr>
    <td colspan="8" class="encabezado centrado bl br bb">Retenciones</td>
    <td width="10%" class="encabezado br bb">Tasa</td>
    <td width="15%" class="encabezado valorUnitario br bb">Importe</td>
  </tr>';
   for($j=0; $j<$numeroderet; $j++)
	{/**/
  $mihtml.= '  
		<tr>
		    <td colspan="8" class="centrado bl br  bb ">'.$impuestosLocales[$j]['descripcion'].'</td>
		    <td class=" br bb">'.$impuestosLocales[$j]['tasa'].'</td>
		    <td class="valorUnitario br bb">$ '.$impuestosLocales[$j]['importe'].'</td>
		  </tr>';
		 /**/
		 // $mihtml.="<pre>".print_r($impuestosLocales,1)."</pre>";
	}
