...
{	
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => '../Libraries/PHPExcel/Writer/{0}.php', 'class' => 'PHPExcel_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => '../Libraries/PHPExcel/Reader/{0}.php', 'class' => 'PHPExcel_Reader_{0}' )
	);
