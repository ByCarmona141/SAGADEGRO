...
require_once '../Libraries/PHPExcel/Reader/Excel5/Escher.php';

/** PHPExcel_Shared_Date */
require_once '../Libraries/PHPExcel/Shared/Date.php';

/** PHPExcel_Shared_Excel5 */
require_once '../Libraries/PHPExcel/Shared/Excel5.php';
...
require_once '../Libraries/PHPExcel/Shared/OLERead.php';
...
/** PHPExcel_NamedRange */
require_once '../Libraries/PHPExcel/NamedRange.php';
	...
	public function load($pFilename)
	{
		...
		if ($res === false) { // check error code
			...
			if($this->_ole->error == 1) { // bad file
				throw new Exception('El Archivo ' . $pFilename . ' no tiene permisos de lectura.');
