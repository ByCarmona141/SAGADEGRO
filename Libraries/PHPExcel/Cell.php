...
require_once ('../Libraries/PHPExcel/Cell/DataValidation.php');

/** PHPExcel_Cell_Hyperlink */
require_once ('../Libraries/PHPExcel/Cell/Hyperlink.php');

/** PHPExcel_Worksheet */
require_once ('../Libraries/PHPExcel/Worksheet.php');

/** PHPExcel_Calculation */
require_once ('../Libraries/PHPExcel/Calculation.php');

/** PHPExcel_Cell_IValueBinder */
require_once ('../Libraries/PHPExcel/Cell/IValueBinder.php');

/** PHPExcel_Cell_DefaultValueBinder */
require_once ('../Libraries/PHPExcel/Cell/DefaultValueBinder.php');
