<?php
	if(isset($Params)){
		$Create = EncodeThis('Action=Crear&Component=' . $Params['Component']);
...
<div class="row">
	<div class="col-md-12">
		<table id="Table_CelaComponente" class="table table-striped table-bordered  table-hover datatable" data-source="<?= $ServerSource; ?>" data-function="<?= $ServerFunction; ?>" data-form="<?= $RouteForm; ?>" <?= $Params; ?>>
			<thead>
			<tr>
				...
				<th class="sortable" width="25%"><div class="text-center"> Solicitante </div></th>
				<th class="sortable" width="35%"><div class="text-center"> Descripci&oacute;n de la Solicitud </div></th>
				<th class="sortable" width="15%"><div class="text-center"> Fecha de Solicitud </div></th>
				<th class="sortable" width="15%"><div class="text-center"> Tipo de Componente </div></th>
				<th class="sortable" width="5%"><div class="text-center"> Trazabilidad </div></th>
				<th class="sortable" width="5%"><div class="text-center"> Finalizar </div></th>
			</tr>
			</thead>
			<tbody>
			</tbody>
...
?>
<div class="modal fade" id="CelaTrazabilidadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
     aria-hidden="true" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true" aria-label="myModalLabel1">&times;</button>
				<h4 class="modal-title">Trazabilidad del Componente</h4>
			</div>
			<div class="modal-body" id="CelaTrazabilidadModalBody">
			</div>
			<div class="modal-footer">
				<input id="CelaTrazabilidadIndex" type="hidden" />
				<input type="checkbox" class="InsertBack" hidden="hidden"/>
