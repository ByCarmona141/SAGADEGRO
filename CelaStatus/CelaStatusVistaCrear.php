...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_CelaStatus" id="Form_CelaStatus" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>">
	<fieldset>
	...
	?>
		<input type="hidden" name="CelaStatusInsert" value="CelaStatusInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
