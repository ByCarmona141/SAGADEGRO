...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_Rack" id="Form_Rack" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>" >
	<fieldset>
	...
	?>
		<input type="hidden" name="RackInsert" value="RackInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
