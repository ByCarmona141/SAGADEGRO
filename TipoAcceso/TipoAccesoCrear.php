...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_TipoAcceso" id="Form_TipoAcceso" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>" >
	<fieldset>
	...
	?>
		<input type="hidden" name="TipoAccesoInsert" value="TipoAccesoInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
