...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_Estatus" id="Form_Estatus" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>" >
	<fieldset>
	...
	?>
		<input type="hidden" name="EstatusInsert" value="EstatusInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
