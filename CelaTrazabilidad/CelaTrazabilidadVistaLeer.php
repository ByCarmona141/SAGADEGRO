<?php
	if(isset($Params)){
		...
		$Params = 'data-params="' . Encrypt(json_encode($Params), $_COOKIE['CelaRandom']) . '"';
	}else{
...
<div class="row">
	...
	<div class="col-md-4 text-left form-inline">
		<?php
			$Label = false;
...
?>
<table id="Table_CelaTrazabilidad" class="table table-striped table-bordered  table-hover datatable" data-source="<?= $ServerSource; ?>" data-function="<?= $ServerFunction; ?>" data-form="<?= $RouteForm; ?>" <?= $Params; ?>>
	<thead>
	<tr>
		...
		<th class="sortable" width="20%"><div class="text-center"> Fecha </div></th>
		<th class="sortable" width="40%"><div class="text-center"> Fase </div></th>
		<th class="sortable" width="30%"><div class="text-center"> Programador </div></th>
	</tr>
	</thead>
	<tbody>
	</tbody>
