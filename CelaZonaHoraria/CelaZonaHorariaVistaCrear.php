...
?>
<form class="form-horizontal form_validate" method="POST" name="Form_CelaZonaHoraria" id="Form_CelaZonaHoraria" action="<?= $FormAction . '?' . EncodeThis('Action=Crear'); ?>">
	<fieldset>
	...
	?>
		<input type="hidden" name="CelaZonaHorariaInsert" value="CelaZonaHorariaInsert"/>
		<span class="clearfix"></span>
		<hr/>
	<?php
		$Back = $FormAction;
