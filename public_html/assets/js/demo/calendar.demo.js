var handleCalendarDemo = function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarElm, {
        ...
        events: [{
        ...
        }, {title: 'Domain name due', start: year + '-' + month + '-15', color: COLOR_BLUE}, {
            ...
            color: COLOR_BLUE
        }, {title: 'Announcement', start: year + '-' + month + '-22T15:00:00', color: COLOR_RED}, {
            title: 'Dinner',
            ...
            color: COLOR_BLUE
        }, {title: 'Chase due', start: year + '-' + month + '-26T12:00:00', color: COLOR_ORANGE}, {
            title: 'Heartguard',
            ...
            color: COLOR_BLUE
        }, {title: 'Web Hosting due', start: year + '-' + month + '-30', color: COLOR_BLUE}]
    });
    calendar.render();
};
