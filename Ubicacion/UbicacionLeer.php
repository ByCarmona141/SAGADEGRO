...
?>
<table id="Table_Ubicacion" class="table table-striped table-bordered  table-hover datatable"
	...
	<tr>
		...
		<th width="30%" class="sortable" ><div class="text-center"> Area </div></th>
		<th width="30%" class="sortable" ><div class="text-center"> Piso </div></th>
	</tr>
	</thead>
	<tbody>
	</tbody>
